...
OBJECTS=capsicum-test-main.o capability-fd.o fexecve.o procdesc.o capmode.o fcntl.o openat.o sysctl.o select.o mqueue.o socket.o capability-fd-pair.o linux.o
